 ...
 */
public class NearbyMessagesConnection implements
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener
{
    private static NearbyMessagesConnection instance = null;

    private final String TAG = "NearbyMessagesConnection";
    ...
    List<NearbyMessagesObserver> observers = new ArrayList<>();

    private NearbyMessagesConnection(Context context)
    {
    ...
    public static NearbyMessagesConnection getInstance(Context context)
    {
        if (instance == null)
        {
            instance = new NearbyMessagesConnection(context);
        }
        return instance;
    }

    public void registerObserver(NearbyMessagesObserver observer)
    {
        this.observers.add(observer);
    }

    public void removeObserver(NearbyMessagesObserver observer)
    {
    ...
    {
        for (NearbyMessagesObserver observer : observers)
        {
